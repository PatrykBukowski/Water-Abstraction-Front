    ...
    <M.MainWrapper>
      <Formik
        ...
        onSubmit={(values) => {
          ...
          props.createUser(username, password, email, nationality).then(() => {
            props.register();
          });
        }}
        validate={(values) => {
          ...
          if (!values.username) {
            ...
            errors.username =
              "Username is too short, minimum 4 chars is required";
          }
          if (!values.email) {
          ...
          if (!values.password) {
            ...
            errors.password =
              "Password is too short, minimum 6 chars is required";
          }
        ...
        {({ values, errors, handleChange, handleSubmit }) => (
          <M.FormWrapper>
            <M.FormContainer onSubmit={handleSubmit}>
              ...
              <M.RegisterButton type="button" onClick={() => props.register()}>
                LOGIN
              </M.RegisterButton>
            </M.FormContainer>
          </M.FormWrapper>
